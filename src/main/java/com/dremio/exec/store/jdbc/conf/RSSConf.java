...
@SourceType(value = "RSSARP", label = "RSS",uiConfig = "rss-layout.json")
public class RSSConf extends AbstractArpConf<RSSConf> {
  private static final String ARP_FILENAME = "arp/implementation/rss-arp.yaml";
  private static final ArpDialect ARP_DIALECT =
      AbstractArpConf.loadArpFile(ARP_FILENAME, (ArpDialect::new));
  private static final String DRIVER = "cdata.jdbc.rss.RSSDriver";
